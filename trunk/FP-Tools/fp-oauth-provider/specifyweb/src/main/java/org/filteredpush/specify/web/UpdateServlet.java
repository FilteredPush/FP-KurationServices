...
public class UpdateServlet extends HelloServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
    		...
    		if (object != null && type != null) {
    			String result = update(type, object, userId);
    			out.println(result);
    		}
            out.close();
	...
	private String update(String type, String object, String userId) throws DataSourceException {
